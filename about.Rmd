...
<p>The primary purpose of this app is to create a user friendly way to take advantage of R packages for parentage assignment and population evaluation using genomic data. The code is available through <a href="https://github.com/samstroupe/ParentageApp">GitHub</a>. You can run the latest GitHub version with the following code. Necessary R packages are listed at the bottom of the page.</p>
<p><code>
...
<h1 style="font-size:150%;"> R Packages:</h1>
<p>"shiny", "sequoia", "Rcpp", "kinship2", "ggplot2", "vcfR", "poppr", "ape", "RColorBrewer", "reshape2", "adegenet", "cowplot", "Cairo", "shinyWidgets", "grDevices", "shinyjs", "shinythemes", "markdown", "DT"</p>
